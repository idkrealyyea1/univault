...
const I18N_DICTS = {
  en: {
    ...
    'adm.users': 'Users',
    'adm.audit': 'Audit Log',
    'hero.badge': 'Join a community of thousands of students',
    'hero.h1.1': 'Study help from people who',
    'hero.h1.2': 'know your university.',
    'hero.sub': 'A platform that connects you with standout university students to help with assignments, projects, studying and so much more.',
    'hero.browse': 'Browse your university',
    'hero.offer': 'Offer your services',
    'hero.benefit1': 'Real experience',
    'hero.benefit2': 'Fair prices',
    'hero.benefit3': 'Fast help',
    'hero.benefit4': 'Trusted & secure',
    'hero.stat.title': 'Our platform in numbers',
    'hero.stat.univ': 'universities',
    'hero.stat.svc': 'services',
    ...
    'unis.sub': 'Choose your university to access its services and help',
    'unis.count': 'campuses',
    'unis.nomatch': 'No universities match "{q}"',
    'unis.search': 'Search your university…',
    ...
    'svc.unlocked.sub': 'You have access to this service. The files and materials are below.',
    'svc.owner.badge': '👤 You are the provider of this service',
    'svc.owner.sub': 'This is your service. Buyers who have access can contact you from the chat below.',
    'svc.owner.files': 'Provider view — manage the files for this service from the admin dashboard.',
    'svc.about': 'About this service',
    'svc.about.none': "The owner hasn't added a description yet.",
    'chat.eyebrow': 'Private chat',
    'chat.title': 'Chat with provider',
    'chat.title.provider': 'Buyer conversations',
    'chat.provider.you': 'You are the provider of this service',
    'chat.ends': 'Expires in',
    'chat.expired.title': '⏳ Chat expired',
    'chat.expired.sub': 'This chat ended 24 hours after it started. New messages can no longer be sent or read here.',
    'chat.empty': 'No messages yet — send the first message to start the chat.',
    'chat.empty.provider': 'No conversations yet. Buyers with access to this service will appear here.',
    'chat.conv.empty': 'No messages in this conversation yet.',
    'chat.placeholder': 'Write a message… (Enter to send, Shift+Enter for a new line)',
    'chat.send': 'Send',
    'chat.you': 'You',
    'chat.older': 'Load older messages',
    'chat.error.send': 'Could not send the message. Try again.',
    'chat.error.load': 'Could not load the chat. Please refresh the page.',
    ...
    'apply.back': 'Back',
    'vault.kicker': 'My Vault',
    'vault.title': 'Notes & saved links',
    'vault.sub': 'Private to your device — nothing here is sent to the server.',
    'vault.add': 'Save note',
    'vault.placeholder': 'Write a note or paste a link…',
    'vault.empty': 'Nothing saved yet — add your first note below.',
    'vault.saved': 'saved items',
    'vault.del': 'Delete',
    'vault.open': 'Open',
    'vault.delete.confirm': 'Delete this note?',
    'library.kicker': 'Library',
    'library.title': 'Resource files',
    'library.sub': 'Files and materials shared by your university services.',
    'library.empty': 'No resources published yet — check back soon.',
    'library.service': 'Service',
    'library.open': 'Open file',
    'notif.kicker': 'Notifications',
    'notif.title': 'Recent activity',
    'notif.sub': 'Everything that happens with your account, in one place.',
    'notif.empty': 'No activity yet — your actions will show up here.',
  ...
  ar: {
    ...
    'hero.badge': 'انضم إلى مجتمع آلاف الطلاب والطالبات',
    'hero.h1.1': 'مساعدة دراسية من أشخاص',
    'hero.h1.2': 'يعرفون جامعتك.',
    'hero.sub': 'منصة تجمعك مع طلاب جامعيين مميزين لمساعدتك في الواجبات، المشاريع، المذاكرة وأكثر من ذلك بكثير.',
    'hero.browse': 'تصفح جامعتك',
    'hero.offer': 'اعرض خدماتك',
    'hero.benefit1': 'خبرة حقيقية',
    'hero.benefit2': 'أسعار مناسبة',
    'hero.benefit3': 'مساعدة سريعة',
    'hero.benefit4': 'موثوق وآمن',
    'hero.stat.title': 'منصتنا بالأرقام',
    'hero.stat.univ': 'جامعة',
    'hero.stat.svc': 'خدمة',
    ...
    'unis.title': 'اختر جامعتك',
    'unis.sub': 'اختر جامعتك للوصول إلى الخدمات والمساعدات المتاحة',
    'unis.count': 'جامعة',
    'unis.nomatch': 'لا توجد جامعات تطابق "{q}"',
    'unis.search': 'ابحث عن جامعتك…',
    ...
    'svc.unlocked.sub': 'لديك حق الوصول إلى هذه الخدمة. الملفات والمواد أدناه.',
    'svc.owner.badge': '👤 أنت مقدم هذه الخدمة',
    'svc.owner.sub': 'هذه خدمتك. المشترون الذين لديهم وصول يمكنهم التواصل معك من الدردشة أدناه.',
    'svc.owner.files': 'عرض مقدم الخدمة — أدر ملفات هذه الخدمة من لوحة المشرف.',
    'svc.about': 'عن هذه الخدمة',
    'svc.about.none': 'لم يضِف صاحب الخدمة وصفاً بعد.',
    'chat.eyebrow': 'محادثة خاصة',
    'chat.title': 'الدردشة مع مقدم الخدمة',
    'chat.title.provider': 'محادثات المشترين',
    'chat.provider.you': 'أنت مقدم هذه الخدمة',
    'chat.ends': 'تنتهي خلال',
    'chat.expired.title': '⏳ انتهت المحادثة',
    'chat.expired.sub': 'انتهت هذه المحادثة بعد 24 ساعة من بدئها. لا يمكن إرسال أو قراءة رسائل جديدة هنا.',
    'chat.empty': 'لا توجد رسائل بعد — أرسل أول رسالة لبدء المحادثة.',
    'chat.empty.provider': 'لا توجد محادثات بعد. سيظهر المشترون الذين لديهم وصول لهذه الخدمة هنا.',
    'chat.conv.empty': 'لا توجد رسائل في هذه المحادثة بعد.',
    'chat.placeholder': 'اكتب رسالتك… (Enter للإرسال، Shift+Enter لسطر جديد)',
    'chat.send': 'إرسال',
    'chat.you': 'أنت',
    'chat.older': 'تحميل رسائل أقدم',
    'chat.error.send': 'تعذر إرسال الرسالة. حاول مرة أخرى.',
    'chat.error.load': 'تعذر تحميل المحادثة. يرجى تحديث الصفحة.',
    ...
    'apply.back': 'العودة',
    'vault.kicker': 'خزنتي',
    'vault.title': 'ملاحظات وروابط محفوظة',
    'vault.sub': 'خاصة بجهازك — لا يُرسل أي شيء من هنا إلى الخادم.',
    'vault.add': 'حفظ الملاحظة',
    'vault.placeholder': 'اكتب ملاحظة أو الصق رابطاً…',
    'vault.empty': 'لا يوجد شيء محفوظ بعد — أضف ملاحظتك الأولى بالأسفل.',
    'vault.saved': 'عنصر محفوظ',
    'vault.del': 'حذف',
    'vault.open': 'فتح',
    'vault.delete.confirm': 'حذف هذه الملاحظة؟',
    'library.kicker': 'المكتبة',
    'library.title': 'ملفات الموارد',
    'library.sub': 'ملفات ومواد يشاركها أصحاب الخدمات في جامعتك.',
    'library.empty': 'لا توجد موارد منشورة بعد — عد لاحقاً.',
    'library.service': 'الخدمة',
    'library.open': 'فتح الملف',
    'notif.kicker': 'الإشعارات',
    'notif.title': 'النشاط الأخير',
    'notif.sub': 'كل ما يحدث لحسابك في مكان واحد.',
    'notif.empty': 'لا يوجد نشاط بعد — ستظهر أفعالك هنا.',
...
let CURRENT_LANG = 'ar';
try { CURRENT_LANG = localStorage.getItem('studora_lang') || 'ar'; } catch (e) { /* private mode */ }
